...
//전통적인 함수에서 this 객체가 의미하는 것은 => 현재 이벤트가 발생된 요소이거나 혹은 class 함수에서 this객체가 의미하는 것은 => 인스턴스 객체안에서 어떤 키를 지칭하고자 할 때

//this 객체는 화살표 함수에서는 사용불가!!
//사용을 하면 코드가 멈추는가?
//this 객체가 가르키는 것이 window 객체이기 때문에 원하는 결과값이 나올 수 없다